...
const { timezone, updateTimezone, getTimezones, getCurrentTimezoneInfo } = useTimezone();
...
// 根据当前语言获取当前时区标签
const currentTimezoneLabel = computed(() => getCurrentTimezoneInfo(locale.value).label);
