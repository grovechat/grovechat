            ...
            <div class="space-y-6">
                ...
                >
                    <div class="grid gap-2">
                        <Label for="current_password">{{ t('password.fields.currentPassword.label') }}</Label>
                        <Input
                            id="current_password"
                    ...
                    <div class="grid gap-2">
                        <Label for="password">{{ t('password.fields.newPassword.label') }}</Label>
                        <Input
                            id="password"
                            name="password"
                            type="password"
                    ...
                    <div class="grid gap-2">
                        <Label for="password_confirmation"
                            >{{ t('password.fields.confirmPassword.label') }}</Label
                        >
                        <Input
                    ...
                    <div class="flex items-center gap-4">
                        <Button
                            ...
                            >{{ t('password.actions.save') }}</Button
                        >
