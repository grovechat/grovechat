...
const viewHideButtonText = computed(() =>
    isRecoveryCodesVisible.value ? t('twoFactor.recoveryCodes.hide') : t('twoFactor.recoveryCodes.view')
);
            ...
            >
                ...
                <div v-else class="mt-3 space-y-3">
                    ...
                    <p class="text-xs text-muted-foreground select-none">
                        ...
                        <span class="font-bold">{{ t('twoFactor.recoveryCodes.regenerateButton') }}</span>
                    </p>
                </div>
            </div>
        </CardContent>
