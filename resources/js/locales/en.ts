...
export default {
  ...
  '输入来自身份验证器应用的 6 位数字验证码': 'Enter the 6-digit code from your authenticator app',
  ...
  '选择你的时区，用于正确显示时间': 'Select your timezone for accurate time display',
  ...
  '在下方输入你的邮箱和密码以登录': 'Enter your email and password below to log in',
  '登录': 'Log in',
  ...
  '在下方输入你的详细信息以创建账户': 'Enter your details below to create your account',
  ...
  // 认证 - 忘记密码
  '忘记密码': 'Forgot password',
  '输入你的电子邮件以接收密码重置链接': 'Enter your email to receive a password reset link',
