...
use App\Data\StorageSetting\GetStorageSettingPagePropsData;
...
class GetStorageSettingAction
{
    ...
    public function handle(): GetStorageSettingPagePropsData
    {
        ...
        return new GetStorageSettingPagePropsData(
