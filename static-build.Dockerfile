...
# PHP 扩展配置
ENV PHP_VERSION=8.5
ENV PHP_EXTENSIONS=bcmath,ctype,dom,fileinfo,filter,mbregex,mbstring,opcache,openssl,pdo,pdo_sqlite,phar,posix,session,simplexml,sqlite3,tokenizer,xml,xmlreader,xmlwriter,zlib
